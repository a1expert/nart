	...
	<div class="carInfo__bottom">
		<div class="container">
			<section class="carDescription">
				...
				<p class="carDescription__text">Автобус средней вместимости, который имеет множество модификаций и рассчитан на перевозку до 33 пассажиров. В нашем автопарке вы  выбрать этот автобус любой вместимости. Кроме того, автобус отличает достаточная степень надежности. Современное оснащение салона и продуманная система управления создают чувство комфорта и безопасности.</p>
			</section>
